...
from transformers_pruning import GPTNeoForCausalLM, GPTNeoXForCausalLM, GPT2Tokenizer, AutoModelForCausalLM
import os
from argparse import ArgumentParser

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# It is used to compute the effects of attentin heads on perplexity using both magnitude and gradient as baselines.
...
if __name__ == "__main__":
    ...
    for model_name in model_names:
      print(model_name)
      biases_scores = "./model/head_scores_" + str(args.model_list[0]) + ".csv"
